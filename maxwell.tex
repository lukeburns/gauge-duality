...
\begin{document}
  ...
  \abstract{Duality symmetry of the generalized Maxwell's equations (with magentic sources) is gauged. Because the newly introduced gauge field is indistinguishable from an electromagnetic gauge field, it is suggested that the coupling could describe non-linear interactions between electromagnetic fields.}
