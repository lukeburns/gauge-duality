...
\begin{document}
  ...
  \abstract{Duality symmetry of the generalized Maxwell's equations (with magentic sources) is gauged. The curvature of the gauge field satisfies Maxwell's equations (without magnetic sources). It is suggested that the coupling could describe non-linear interactions between electromagnetic fields.}
