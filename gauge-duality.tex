...
\title{Can duality symmetry of Maxwell's equations be gauged?}
\author{Luke Burns}
...
\begin{@twocolumnfalse}
  ...
  \abstract{It is argued that duality symmetry of the generalized Maxwell's equations (with magentic sources) \emph{can} be gauged in the usual way, and that arguments against incorrectly assume a particular form of potential or Lagrangian.}
